  ...
  describe('node_standard', () => {
    ...
    describe('copyFiles', () => {
      it('should call the right methods with the right params', () => {
        ...
        let _fifthCall = [`node/koa/no_transpiler/endpoint.dao.spec.js`, `${knownPaths.PATH_SERVER_FEATURES_TEST + _newGenerator.feature}/dao/${_newGenerator.name}-dao.spec.js`, {name: _newGenerator.name, nameLowerCase: _newGenerator.name.toLowerCase(), feature: _newGenerator.feature}];
  ...
  describe('node_babel', () => {
    ...
    describe('copyFiles', () => {
      it('should call the right methods with the right params', () => {
        ...
        let _fifthCall = [`node/koa/babel/endpoint.dao.spec.js`, `${knownPaths.PATH_SERVER_FEATURES_TEST + _newGenerator.feature}/dao/${_newGenerator.name}-dao.spec.js`, {name: _newGenerator.name, nameLowerCase: _newGenerator.name.toLowerCase(), feature: _newGenerator.feature}];
  ...
  describe('node_typescript', () => {
    ...
    describe('copyFiles', () => {
      it('should call the right methods with the right params', () => {
        ...
        let _fifthCall = [`node/koa/typescript/endpoint.dao.spec.js`, `${knownPaths.PATH_SERVER_FEATURES_TEST + _newGenerator.feature}/dao/${_newGenerator.name}-dao.spec.js`, {name: _newGenerator.name, nameLowerCase: _newGenerator.name.toLowerCase(), feature: _newGenerator.feature}];
