...
describe('FilterSubGenerator', () => {
  ...
  describe('writing', () => {
    ...
    it('should have the writing called with the right stuff', () => {
      ...
      let _secondCall = ['filter.spec.js', knownPaths.PATH_CLIENT_FEATURES_TEST + _gen.options.feature + '/filters/' + _gen.name + '.spec.js', {name: _gen.name, appName: _gen.appName}]
