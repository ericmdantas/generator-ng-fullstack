  ...
  describe('go', () => {
    ...
    describe('copyForMainGenerator', () => {
      it('should call the right methods with the right params', () => {
        ...
        let _firstCall = [`server_go/main.go`, `server/main.go`, {appName: _newGenerator.appName, username: _newGenerator.userName, differentStaticServer: !!_newGenerator.differentStaticServer}];

        let _secondCall = [`server_go/routes/routes.go`, `server/routes/routes.go`, {username: _newGenerator.userName, appName: _newGenerator.appName, differentStaticServer: !!_newGenerator.differentStaticServer}];
        let _thirdCall = [`server_go/routes/routes_test.go`, `server/routes/routes_test.go`, {username: _newGenerator.userName, appName: _newGenerator.appName, differentStaticServer: !!_newGenerator.differentStaticServer}];

        let _fourthCall = [`server_go/config/dbconfig.go`, `server/config/dbconfig.go`, {username: _newGenerator.userName, appName: _newGenerator.appName, differentStaticServer: !!_newGenerator.differentStaticServer}];
        let _fifthCall = [`server_go/config/dbconfig_test.go`, `server/config/dbconfig_test.go`, {username: _newGenerator.userName, appName: _newGenerator.appName, differentStaticServer: !!_newGenerator.differentStaticServer}];

        let _sixthCall = [`server_go/common/static/static.go`, `server/common/static/static.go`, {username: _newGenerator.userName, appName: _newGenerator.appName, differentStaticServer: !!_newGenerator.differentStaticServer}];
        let _seventhCall = [`server_go/common/static/static_test.go`, `server/common/static/static_test.go`, {username: _newGenerator.userName, appName: _newGenerator.appName, differentStaticServer: !!_newGenerator.differentStaticServer}];

        let _eighthCall = [`server_go/api/todo/routes/todoroutes.go`, `${knownPaths.PATH_SERVER_FEATURES}todo/routes/todoroutes.go`, {username: _newGenerator.userName, appName: _newGenerator.appName, differentStaticServer: !!_newGenerator.differentStaticServer}];
        let _ninethCall = [`server_go/api/todo/routes/todoroutes_test.go`, `${knownPaths.PATH_SERVER_FEATURES}todo/routes/todoroutes_test.go`, {username: _newGenerator.userName, appName: _newGenerator.appName, differentStaticServer: !!_newGenerator.differentStaticServer}];

        let _tenthCall = [`server_go/api/todo/model/todomodel.go`, `${knownPaths.PATH_SERVER_FEATURES}todo/model/todomodel.go`, {username: _newGenerator.userName, appName: _newGenerator.appName, differentStaticServer: !!_newGenerator.differentStaticServer}];
        let _eleventhCall = [`server_go/api/todo/model/todomodel_test.go`, `${knownPaths.PATH_SERVER_FEATURES}todo/model/todomodel_test.go`, {username: _newGenerator.userName, appName: _newGenerator.appName, differentStaticServer: !!_newGenerator.differentStaticServer}];

        let _twelfthCall = [`server_go/api/todo/dao/tododao.go`, `${knownPaths.PATH_SERVER_FEATURES}todo/dao/tododao.go`, {username: _newGenerator.userName, appName: _newGenerator.appName, differentStaticServer: !!_newGenerator.differentStaticServer}];
        let _thirteenthCall = [`server_go/api/todo/dao/tododao_test.go`, `${knownPaths.PATH_SERVER_FEATURES}todo/dao/tododao_test.go`, {username: _newGenerator.userName, appName: _newGenerator.appName, differentStaticServer: !!_newGenerator.differentStaticServer}];

        let _fourteenthCall = [`server_go/api/todo/controller/todocontroller.go`, `${knownPaths.PATH_SERVER_FEATURES}todo/controller/todocontroller.go`, {username: _newGenerator.userName, appName: _newGenerator.appName, differentStaticServer: !!_newGenerator.differentStaticServer}];
        let _fifteenfhCall = [`server_go/api/todo/controller/todocontroller_test.go`, `${knownPaths.PATH_SERVER_FEATURES}todo/controller/todocontroller_test.go`, {username: _newGenerator.userName, appName: _newGenerator.appName, differentStaticServer: !!_newGenerator.differentStaticServer}];
      ...
      it('should call the right methods with the right params - secure', () => {
        ...
        let _firstCall = [`server_go/main_http2.go`, `server/main.go`, {appName: _newGenerator.appName, username: _newGenerator.userName, differentStaticServer: !!_newGenerator.differentStaticServer}];
