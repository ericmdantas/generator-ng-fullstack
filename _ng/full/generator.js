...
const NodeStandard = require('../server/node').NodeStandard;
const NodeBabel = require('../server/node').NodeBabel;
const NodeTypescript = require('../server/node').NodeTypescript;
